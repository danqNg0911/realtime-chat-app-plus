...
const getAssistantConfig = () => ({
  ...
  image: process.env.AI_ASSISTANT_IMAGE || "https://i.pinimg.com/originals/02/ac/32/02ac324ac4256566ff7d2aad37defd15.jpg",
...
export const ensureAiAssistantUser = async () => {
  ...
  if (!assistant) {
    ...
    // Update AI assistant info if env vars changed (including image)
    let updated = false;
