...
const RAW_SERVER_URL = import.meta.env.VITE_SERVER_URL || (typeof window !== "undefined" ? window.location.origin : "");
export const HOST = RAW_SERVER_URL;
export const SOCKET_HOST = import.meta.env.VITE_SOCKET_URL || RAW_SERVER_URL;
export const SOCKET_PATH = "/socket.io";
export const UPLOADS_HOST = import.meta.env.VITE_UPLOAD_BASE || HOST;
